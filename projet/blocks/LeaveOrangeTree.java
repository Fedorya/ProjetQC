...
public class LeaveOrangeTree extends BlockLeavesBase{
	protected Icon fastIcon;
	
	public LeaveOrangeTree(int par1) {
		super(par1,Material.leaves,false);
				
		this.setTickRandomly(true);
        this.setCreativeTab(Main.ProjetCreativetabDecorations);
        this.setStepSound(Block.soundGrassFootstep);
        this.setUnlocalizedName(Names.Leave_OrangeTree_unlocalizedName);
	...
	public void registerIcons(IconRegister icon){
		blockIcon = icon.registerIcon(ModInfo.ID.toLowerCase() + ":" + Names.Leave_OrangeTree_unlocalizedName);
		fastIcon = icon.registerIcon(ModInfo.ID.toLowerCase() + ":" + Names.Leave_OrangeTree_Opaque_unlocalizedName);
	}
